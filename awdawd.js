...
occluderMat.diffuseColor = new BABYLON.Color3(0, 1, 0); 
...
function activatePortal() {
    ...
    rahmenL.position.set(-reticleSizeX / 2, 0, 0); 
    rahmenR.position.set(reticleSizeX / 2, 0, 0); 
    rahmenO.rotation.z = Math.PI / 2;  
    rahmenO.position.set(0, reticleSizeY / 2, 0); 
    rahmenU.rotation.z = Math.PI / 2;  
    rahmenU.position.set(0, -reticleSizeY / 2, 0); 
